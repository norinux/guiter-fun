  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-end md:hidden border-t border-white/10 bg-nav-bg">
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary shadow-lg shadow-primary/30 transition-transform active:scale-95">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round">
              <line x1="12" y1="5" x2="12" y2="19" />
              <line x1="5" y1="12" x2="19" y2="12" />
            </svg>
          </div>
          <span className="mt-0.5 text-[10px] font-medium text-slate-500 pb-1">投稿</span>
        </button>
